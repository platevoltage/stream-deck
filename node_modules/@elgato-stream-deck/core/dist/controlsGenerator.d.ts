...
export declare function generateButtonsGrid(width: number, height: number, pixelSize: Dimension, rtl?: boolean, columnOffset?: number): StreamDeckButtonControlDefinition[];
